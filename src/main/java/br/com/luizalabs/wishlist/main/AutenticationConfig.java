...
import br.com.luizalabs.wishlist.infrastructure.gateways.AutenticationServiceGateway;
...
public class AutenticationConfig {
    ...
    AuthenticationGateway authenticationGateway(PasswordEncoder passwordEncoder, TokenService tokenService) {
        return new AutenticationServiceGateway(passwordEncoder, tokenService);
    }
 }
